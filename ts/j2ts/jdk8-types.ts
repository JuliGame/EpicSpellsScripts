...
interface APIStatic {
	...
	getSpell( arg0:string ):any /*net.juligame.epicspells.classes.spell.Spell*/;
	getSpellLogic( arg0:string ):net.juligame.epicspells.classes.spell.SpellLogic;
	getWandModel( arg0:org.bukkit.inventory.ItemStack ):net.juligame.epicspells.classes.wand.WandModel;
	reloadAll(  ):void;
	startup(  ):void;
}
...
interface CastEventStatic {
	...
	readonly class:any;
	new( arg0:org.bukkit.entity.Player, arg1:org.bukkit.Location, arg2:net.juligame.epicspells.classes.spell.SpellStats ):net.juligame.epicspells.classes.spell.events.CastEvent;
}
...
interface DotStatic {
	...
	readonly class:any;
	new( arg0:org.bukkit.Particle, arg1:int, arg2:net.juligame.epicspells.classes.util.Hitbox, arg3:org.bukkit.entity.Player ):net.juligame.epicspells.classes.effects.Dot;
}
...
interface ElementStatic {
	...
	readonly class:any;
	valueOf<T>( arg0:java.lang.Class<T>, arg1:string ):T;
	valueOf( arg0:string ):net.juligame.epicspells.classes.enums.Element;
...
interface EpicPlayerStatic {
	...
	new( arg0:net.juligame.epicspells.classes.enums.Element ):net.juligame.epicspells.classes.EpicPlayer;
	get( arg0:org.bukkit.entity.Player ):net.juligame.epicspells.classes.EpicPlayer;
}
...
interface HitboxStatic {
	...
	readonly class:any;
	new( arg0:double, arg1:double, arg2:double ):net.juligame.epicspells.classes.util.Hitbox;
}
...
interface MultiDotStatic {
	...
	readonly class:any;
	new( arg0:org.bukkit.Particle, arg1:int, arg2:net.juligame.epicspells.classes.util.Hitbox, arg3:org.bukkit.entity.Player, arg4:int, arg5:int, arg6:int ):net.juligame.epicspells.classes.effects.MultiDot;
}
...
interface PentagramaStatic {
	...
	readonly class:any;
	get( arg0:int, arg1:float ):net.juligame.epicspells.classes.effects.Pentagrama;
	get( arg0:int, arg1:int, arg2:float ):net.juligame.epicspells.classes.effects.Pentagrama;
}
...
interface SpellLogicStatic {
	...
	readonly class:any;
	new( arg0:string ):net.juligame.epicspells.classes.spell.SpellLogic;
	new( arg0:string, arg1:any /*java.lang.Object*/ ):net.juligame.epicspells.classes.spell.SpellLogic;
}
...
interface SpellStatsStatic {
	...
	readonly class:any;
	new( arg0:net.juligame.epicspells.classes.enums.Element, arg1:double, arg2:int, arg3:int, arg4:double, arg5:int ):net.juligame.epicspells.classes.spell.SpellStats;
...
interface WandEventStatic {
	...
	readonly class:any;
	new( arg0:org.bukkit.entity.Player, arg1:org.bukkit.inventory.ItemStack, arg2:net.juligame.epicspells.classes.wand.WandModel ):net.juligame.epicspells.classes.wand.events.WandEvent;
}
...
interface WandLogicStatic {
	...
	readonly class:any;
	new( arg0:string ):net.juligame.epicspells.classes.wand.WandLogic;
	new( arg0:any /*org.mozilla.javascript.NativeJavaObject*/ ):net.juligame.epicspells.classes.wand.WandLogic;
}
...
interface WandModelStatic {
	...
	new( arg0:string, arg1:string, arg2:string ):net.juligame.epicspells.classes.wand.WandModel;
}
