...
class EpicPlayer/* extends net.juligame.Jsql.JSql*/ {
	...
	delete(  ):void;
	equals( arg0:any /*java.lang.Object*/ ):boolean;
	getPlayerWand( arg0:net.juligame.epicspells.classes.wand.WandModel ):any /*net.juligame.epicspells.classes.wand.PlayerWand*/;
	getPlayerWand( arg0:string ):any /*net.juligame.epicspells.classes.wand.PlayerWand*/;
	save(  ):void;
	toString(  ):string;
...
class Dot/* extends net.juligame.epicspells.classes.effects.interfaces.movable implements net.juligame.epicspells.classes.effects.interfaces.hittable*/ {
	...
	MoveTo( arg0:org.bukkit.Location, arg1:float, arg2:any /*net.juligame.epicspells.classes.enums.Interpolations*/ ):void;
	MoveTo( arg0:org.bukkit.Location, arg1:float, arg2:float ):void;
	Spawn( arg0:org.bukkit.Location ):void;
	equals( arg0:any /*java.lang.Object*/ ):boolean;
	getCurrentLocation(  ):org.bukkit.Location;
	getHitbox(  ):net.juligame.epicspells.classes.util.Hitbox;
	onEndMove( arg0:boolean ):void;
	setOnCasterHit( arg0:Func<org.bukkit.entity.LivingEntity, boolean|null> ):void;
	setOnEntityHit( arg0:Func<org.bukkit.entity.LivingEntity, boolean|null> ):void;
	setOnGroundHit( arg0:org.bukkit.util.Consumer<org.bukkit.Location> ):void;
	startHitDetection( arg0:Func<java.util.List<org.bukkit.entity.LivingEntity>, boolean|null> ):void;
	stopMove(  ):void;
	toString(  ):string;
...
class MultiDot/* extends Dot*/ {
	...
	MoveTo( arg0:org.bukkit.Location, arg1:float, arg2:float ):void;
	Spawn( arg0:org.bukkit.Location ):void;
	Spawn( arg0:org.bukkit.Location, arg1:int ):void;
	equals( arg0:any /*java.lang.Object*/ ):boolean;
	getCurrentLocation(  ):org.bukkit.Location;
	getHitbox(  ):net.juligame.epicspells.classes.util.Hitbox;
	onEndMove( arg0:boolean ):void;
...
class Pentagrama/* extends java.lang.Object*/ {
	...
	addRotation( arg0:double, arg1:double, arg2:double ):void;
	chageRotation( arg0:double, arg1:double, arg2:double ):void;
	changeRGB( arg0:int, arg1:int, arg2:int ):void;
	drawFrame( arg0:org.bukkit.Location ):void;
	equals( arg0:any /*java.lang.Object*/ ):boolean;
	toString(  ):string;
...
class SpellLogic/* extends java.lang.Object*/ {
	...
	setOnCast( arg0:Func<net.juligame.epicspells.classes.spell.events.CastEvent, boolean|null> ):void;
	toString(  ):string;
...
class SpellStats/* extends java.lang.Object*/ {
	...
	add( arg0:SpellStats ):SpellStats;
	equals( arg0:any /*java.lang.Object*/ ):boolean;
	getAlcance(  ):int;
	getArea(  ):double;
	getCooldown(  ):int;
...
class Hitbox/* extends java.lang.Object*/ {
	...
	equals( arg0:any /*java.lang.Object*/ ):boolean;
	getHitEntities( arg0:org.bukkit.Location ):java.util.List<org.bukkit.entity.LivingEntity>;
	toString(  ):string;
...
class WandLogic/* extends java.lang.Object*/ {
	...
	setOnEvent( arg0:org.bukkit.util.Consumer<net.juligame.epicspells.classes.wand.events.WandEvent> ):void;
	toString(  ):string;
...
class WandModel/* extends java.lang.Object*/ {
	...
	OnBasicCast( arg0:org.bukkit.entity.Player, arg1:org.bukkit.inventory.ItemStack ):void;
	OnEquip( arg0:org.bukkit.entity.Player, arg1:org.bukkit.inventory.ItemStack ):void;
	OnSecondaryCast( arg0:org.bukkit.entity.Player, arg1:org.bukkit.inventory.ItemStack ):void;
	OnUnequip( arg0:org.bukkit.entity.Player, arg1:org.bukkit.inventory.ItemStack ):void;
	StartHold( arg0:org.bukkit.entity.Player ):void;
	StopHold( arg0:org.bukkit.entity.Player ):void;
	equals( arg0:any /*java.lang.Object*/ ):boolean;
...
interface Player/* extends HumanEntity, org.bukkit.conversations.Conversable, org.bukkit.OfflinePlayer, org.bukkit.plugin.messaging.PluginMessageRecipient, net.kyori.adventure.identity.Identified, com.destroystokyo.paper.network.NetworkClient*/ {
	...
	getHurtDirection(  ):float;
	getHurtSound(  ):org.bukkit.Sound;
	getInventory(  ):any /*org.bukkit.inventory.PlayerInventory*/;
